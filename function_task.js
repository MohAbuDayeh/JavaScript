...
//   const maxAge = 100;
//   const totalSupply = (maxAge - age) * amountPerDay * 365;
//   return `You will need ${totalSupply} to last you until the ripe old age of ${maxAge}`;
// }
...
// x is undefined in the first function.
// Functions cannot have literal values like 7 or '7' as names.
// Using strings like 'x' inside math operations is invalid.
...
//   return age >= 20
//     ? "yes you can"
//     : `please come back after ${20 - age} years to get one`;
// }
...
//   let valueBeforeReset = counterValue;
//   counterValue = 0;
//   return `${valueBeforeReset} and the counter reset now`;
// }
// console.log(counter()); 
// console.log(counter()); 
